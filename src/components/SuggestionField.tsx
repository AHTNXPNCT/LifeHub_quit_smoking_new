...
// Zustand selectors must return the same reference while data is unchanged.
// A newly created [] for a field without saved suggestions caused React to
// endlessly re-render every journal form as soon as it opened.
